...
public class MainActivity extends AppCompatActivity {private static final String TAG = "paymentExample";
    /**
    ...
    protected void displayResultText(String result) {
        ((TextView)findViewById(R.id.txtResult)).setText("Result : " + result+Long.toHexString(Double.doubleToLongBits(Math.random())));
        Toast.makeText(
